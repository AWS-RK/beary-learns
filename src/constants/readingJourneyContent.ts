...
export const JOURNEY_UNITS: UnitContent[] = [
  ...
  },
  {
    unitNumber: 8,
    title: 'Kate Skates',
    pattern: 'Long A words — skate, gate, wave, brave, name',
    badgeId: 'SKATE_STAR',
    words: [
      { word: 'skate', emoji: '⛸️' },
      { word: 'gate', emoji: '🚪' },
    ...
    comprehensionItems: [
      {
        passage: 'Kate put on her skates at the gate. She was not late for the race.',
        question: 'Where did Kate put on her skates?',
        answer: 'at the gate',
        choices: ['at the gate', 'at the lake', 'at her place'],
      },
      {
        passage: 'Kate skated to the place by the lake. She waved her hand and smiled.',
        question: 'Where did Kate skate to?',
        answer: 'the place by the lake',
        choices: ['the place by the lake', 'the gate', 'the race track'],
      },
      {
        passage: 'Kate was brave. She did not fall when she came to the big gate.',
        question: 'What kind of skater was Kate?',
        answer: 'brave',
        choices: ['brave', 'late', 'same'],
      },
      {
        passage: 'Kate and her friend had the same name. They played a skate game together.',
        question: 'What did Kate and her friend have the same?',
        answer: 'name',
        choices: ['name', 'face', 'skate'],
      },
      {
        passage: 'Kate came in first place in the race. She waved to the crowd and made a big smile.',
        question: 'What place did Kate come in?',
        answer: 'first place',
        choices: ['first place', 'last place', 'same place'],
      },
    ],
  },
  {
    ...
    pattern: 'Sea and animal words — swim, splash, dive, shore',
    badgeId: 'SEAL_SWIMMER',
    words: [
      { word: 'seal', emoji: '🦭' },
      { word: 'swim', emoji: '🏊' },
      { word: 'fish', emoji: '🐟' },
    ...
    comprehensionItems: [
      {
        passage: 'Sammy the seal swam in the cold sea. He jumped up to catch a fish.',
        question: 'What did Sammy catch?',
        answer: 'a fish',
        choices: ['a fish', 'a wave', 'a friend'],
      },
      {
        passage: 'Sammy went to school to see the kids. The kids wanted to play with him.',
        question: 'Where did Sammy go?',
        answer: 'to school',
        choices: ['to school', 'to the sea', 'to the shore'],
      },
      {
        passage: 'Sammy splashed in the water by the shore. The big wave got the kids wet.',
        question: 'What got the kids wet?',
        answer: 'the big wave',
        choices: ['the big wave', 'Sammy the seal', 'the cold fish'],
      },
      {
        passage: 'Sammy liked to dive deep in the sea. He could swim and play in the cold water.',
        question: 'What did Sammy like to do?',
        answer: 'dive deep in the sea',
        choices: ['dive deep in the sea', 'go to school', 'sit on the shore'],
      },
      {
        passage: 'The kids at school said Sammy was a good friend. He made them laugh with his splashes.',
        question: 'What did Sammy do that made the kids laugh?',
        answer: 'his splashes',
        choices: ['his splashes', 'his dives', 'his school'],
      },
    ],
  },
  {
    unitNumber: 10,
    title: 'Sprinkles and Swirls',
    pattern: 'Fun park words — spin, slide, zoom, ride, cheer',
    badgeId: 'PARK_PRINCESS',
    words: [
      { word: 'spin', emoji: '🌀' },
      { word: 'slide', emoji: '🛝' },
      { word: 'ride', emoji: '🎠' },
    ...
    comprehensionItems: [
      {
        passage: 'We went to the fun park. We got on the big slide and zoomed down fast.',
        question: 'What did we zoom down?',
        answer: 'the big slide',
        choices: ['the big slide', 'the swing', 'the loop'],
      },
      {
        passage: 'The swing went high in the sky. We shouted with joy as we flew up.',
        question: 'How high did the swing go?',
        answer: 'high in the sky',
        choices: ['high in the sky', 'down the slide', 'into a loop'],
      },
      {
        passage: 'The ride had a loop. It spun us round and round so fast we had to laugh.',
        question: 'What made us laugh?',
        answer: 'spinning round and round',
        choices: ['spinning round and round', 'the sweet treat', 'the big swing'],
      },
      {
        passage: 'We ran to get in line. We cheered and jumped when the ride started to zoom.',
        question: 'What did we do when the ride started?',
        answer: 'cheered and jumped',
        choices: ['cheered and jumped', 'shouted and ran', 'laughed and slid'],
      },
      {
        passage: 'The park was full of fun. At the end we had a sweet treat and cheered for a great day.',
        question: 'What did we have at the end of the day?',
        answer: 'a sweet treat',
        choices: ['a sweet treat', 'a fast ride', 'a big spin'],
      },
    ],
  },
];
